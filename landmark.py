...
if __name__ == '__main__':
    ...
    # dataset_val = get_parsed_dataset(record_file=args.val_record, batch_size=args.batch_size, shuffle=False)
    dataset_val = get_dataset('/home/dilip/Code/ml/testing/npys/val.npy', args.batch_size)
    ...
    # dataset_train = get_parsed_dataset(record_file=args.train_record, batch_size=args.batch_size, shuffle=True)
    dataset_train = get_dataset('/home/dilip/Code/ml/testing/npys/train.npy', args.batch_size)

    model.fit(dataset_train, validation_data=dataset_val, epochs=args.epochs, callbacks=callbacks)
